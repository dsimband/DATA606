...
|       **Each row of the matrix represents and indiviual with their demographic data, smoking status and region they live in.** 

(b) How many participants were included in the survey?

|       **1693 observations were included in the data**
...
|       **yes the findings from the sample group can be generalized to the population**
...
|       **no - the study finds a coorolation but does not assert any findings realted to causality. Although it concludes that there is a coorelation between smoking and dementia in later life it does not create a causal link**
...
|       **no - the study finds a coorolation but does not assert any findings realted to causality. Although it concludes that sleep disorders and bulling behavior are correlated it makes no assertions about a causal link.**
...
|       **treatment group - half the population that was instructed to exercise twice a week**
|       **control - half the popluation that was instructed not to exercise**

(c) Does this study make use of blocking? If so, what is the blocking variable?

|       **this is not an example of blocking. the age groups are stratified** 

(d) Does this study make use of blinding?

|       **no the treatment group is clearly observable**
...
|       **yes because the mental health of treatment subjects is explored before and after the treatment period** 

(f) Suppose you are given the task of determining if this proposed study should get funding. Would you have any reservations about the study proposal?

|       **The study only includes one frequency of exersize and it will be dificult to ensure compliance**
