...
**intercept: if a mother does not smoke the predicted birth weight is 123.05**
**slope: if a mother smokes the birth weith will be 8.94 ounces**
**predicted weight if a mother does not smoke is 123.05**
**predicted weight if a mother smokes is 114.11**
...
$$ \widehat{abs} = 18.93 -9.11 \times eth 
        +3.10 \times male
        +2.15 \times slow $$
...
**intercept: model predicts 18.93 absence days for non aboriginal, female, average learners**
**not aboriginal - results in a decrease of 9.11 absence days**
**male - increase the absence days by 3.11**
**slow learners - increase the absence days by 2.15 **
...
**intercept: 11.663 if the tempurature is 0 it is expected that 11.663 o rings will fail**
**slope: for each 0.216 decrease temperature an oring will fail **
...
**intercept: at a temperature of 0 11.66 o rings will fail  **
**slope: for each 1 degree decrease in temperature 0.216 o rings will fail **
