...
heart_transplant %>%
  summarise(survivalCount = sum(survived == 'dead'))

heart_transplant %>%
  summarise(survivalCount = sum(survived == 'alive'))

heart_transplant %>%
  summarise(transplantCount = sum(transplant == 'control'))

heart_transplant %>%
  summarise(transplantCount = sum(transplant == 'treatment'))
