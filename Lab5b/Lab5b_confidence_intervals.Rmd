...
- **61.7% think climate change affects their community **
...
- **no - Since this is a quasi random sample the proportions will be different unless they us the same seed**
...
- **We are 95% confident that the true population parameter is in this interval **
...
- **98% no because it is an estimate 95% would be 47.5**

![Facebook Plot](./facebook_plot95.png)
...
- **wider - i chose 98% confidence **

![Facebook Plot](./facebook_plot98.png)
...
- **lower confidence interval 0.5 **
- **upper confidence interval 0.717 **
...
- **percentage was 88% the confidence interval was 90% **

    
 ![Facebook Plot](./facebook_plot90.png)   
...
- **wider**   
- **lower confidence interval 0.45 **
- **upper confidence interval 0.75 **
...
- **as the sample size increases the interval width deceases**
    
 ![Facebook Plot](./facebook_plot20s.png)  
 
 ![Facebook Plot](./facebook_plot1000s.png)   
...
- **the number of bootstrap sample does not contribute to the standard error**



![Facebook Plot](./facebook_plot20bs.png) 

![Facebook Plot](./facebook_plot50000bs.png) 
