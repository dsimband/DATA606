...
- **rows - observactions 1,458**
- **colums - variables 123**
...
- **form: linear**
- **direction: positive**
- **stregth: moderate the points seem to be somewhat scattered**
...
- **yes the histogram is close to normal distribuion and the normal probablity plot is almost a straight line**
...
ggplot(hfi, aes(x=ef_legal_protection, y=pf_score)) + geom_point(alpha = 1/5) + ggtitle("ef_legal_protection")
ggplot(hfi, aes(x=pf_association_sport, y=pf_score)) + geom_point(alpha = 1/5) + ggtitle("pf_association_sport")
ggplot(hfi, aes(x=pf_rol_criminal, y=pf_score)) + geom_point(alpha = 1/5) + ggtitle("pf_rol_criminal")
ggplot(hfi, aes(x=pf_ss_homicide, y=pf_score)) + geom_point(alpha = 1/5) + ggtitle("pf_ss_homicide")
```
