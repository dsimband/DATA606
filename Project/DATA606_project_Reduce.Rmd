...
# Step:  AIC=23075.37
# cfpb_score ~ econ_hh_income + econ_inc_volatility + econ_savings + 
#    dem_age + fin_achieve_goals + fin_saving_habit + fin_set_goals
...
lm_fit <- lm_model %>% 
          fit(cfpb_score ~ econ_hh_income + econ_inc_volatility + econ_savings + 
                    dem_age + fin_achieve_goals + fin_saving_habit + fin_set_goals
