...
(Please note - that 10 questions that are used to calculate the CFPB score are not included in the attributes evaluated in this analysis)
...
Model stats
- r-squared for the model is 0.5633
