...
- **The distribution of the sample is similar to the population. There are slightly fewer individuals in the sample that believe that science benefits them.**
...
- **no - The number should be fairly close but will have some variability. close to the standard distribution**
...
- **the sample proportions are slightly different (sample1 74% benefits and in sample2 78% benefits)  **
- **the larger sample will be a more accurate estimate**
...
**There are 15,000 observations in sample_props50. Each observation has 4 variables. The samples are normaly distributed around a mean of 0.2 and standard deviation of 0.06**
...
- **21 observations. each observation represents the proportion of individual "doesn't benefit" samples.If a record is missing for a sample then all individual samples had the value "Benefits"**
...
- **shape - right skewed but close to a normal distribution** 
- **proportion - 80.2% believe science enhances their lives**
- **population proportion - 80.0% believe science enhances their lives**
...
9.  Change your sample size from 15 to 150, then compute the sampling 
  ...
  - **I would guess the true proportions were 80.03% or 80%**
...
-**the sampling distribution is smaller if you use a larger samples size. when we go from 15 to 150 the distributions is smaller**
