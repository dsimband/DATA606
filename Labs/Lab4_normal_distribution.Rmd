...
+ Median 220 - when compaired to the median at McDonald's this is 20 points lower
+ Mean 260 - when compaired to the mean at McDonald's this is 20 points lower
...
**The distribution of calories in the dairy queen data is closer to normal or bell shaped than the distribution of calaries for McDonald's.The distribution of the McDonald's data appears to schew right.** 
...
1 - pnorm(q = 700, mean = mean(arbys$calories), sd = sd(arbys$calories))
...
**Burger King and the closest to normal distributions Arby's**
...
**when you see stepwise paterns it usually corresponds to gaps in records that correspond to those values. You can see from the histogram above that the records between 2000 and 3000 is sparce **
