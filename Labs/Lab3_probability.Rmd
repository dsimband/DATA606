---
title: "DATA606 Lab3 Probability"
...
* a hit followed by a missed shot is a streak length of 1
* 1 hit and 1 miss 
* a streak length of 0 is a single missed shot
...
**The distribution is right sckewed. With the mode of 0 and max of 4**
...
**If we can compair the distribution of streaks between Kobe's play off performance and a random set of that generates a similar hit percentage then we can observe if the hot had exists or are we observing the natural distribution of events given Kobe's shooting percentage**
...
4.  What change needs to be made to the `sample` function so that it reflects a 
    ...
    * size should be increased 133
    * probablility should be set to 45% likelyhood of a H and 55% likelyhood of a M
...
**i would expect the streak distribution to be consistent**
...
**the hot hand model does not hold up to analysis**
