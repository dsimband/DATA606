...
**- The 2nd histogram with the bin width of 15 is the most detailed. The default bin width of 15 is used for the first histogram. And the final histogram uses a bin width of 150 that obscures most of the variation in departure time. 
